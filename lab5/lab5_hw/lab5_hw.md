...
```r
superhero_info <-  dplyr::rename(superhero_info, gender = "Gender", eye_color = "Eye color", race = "Race", hair_color = "Hair color", height = "Height", publisher = "Publisher", skin_color = "Skin color", alignment = "Alignment", weight = "Weight")
names(superhero_info)
```
...
## #   ³​publisher, ⁴​skin_color, ⁵​alignment
```
Reassuringly, there are more good guys that are bald.
...
We don't have 16 rows in question 10 because questions 11 and 12 both include Sasquach and Wolfsbane, 
