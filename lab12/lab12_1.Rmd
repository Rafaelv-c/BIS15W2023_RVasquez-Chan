...
#stuff above is not actually connected to any data yet
...
ui <- fluidPage(
    ...
    selectInput("y", "Select Y Variable", choices = c("bill_length_mm", "bill_depth_mm", "flipper_length_mm", "body_mass_g"), 
              selected = "bill_length_mm"),
    plotOutput("plot", width = "500px", height = "400")
)
...
```{r}
ui2 <- fluidPage(
    radioButtons("fill", "Select fill Variable", choices = c("trophic.guild", "thermoregulation"), 
