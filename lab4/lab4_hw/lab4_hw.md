...
```r
smallest_homerange_snake <- filter(snakes, mean.hra.m2 ==200)
...
## #   ²​primarymethod, ³​mean.mass.g, ⁴​log10.mass
```
Averaging about 20 centimeters, the Namaqua dwarf adder is one of the smallest vipers on Earth.
